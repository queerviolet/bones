...
var data = {
  users: [
    { name: 'Swag Master', email: 'Swag@Master.com', addresses: ['5 Hanover Square, New York, NY, 10004'], isAdmin: true, password_digest: 'abcd' },
    { name: 'Sag Mistress', email: 'Sag@Mistress.com', addresses: ['5 Hanover Square, New York, NY, 10004'], isAdmin: false, password_digest: 'efgh' },
    { name: 'Random Man', email: 'Man@Random.com', addresses: ['10 SandOver Pear, New York, NY, 11111'], isAdmin: false, password_digest: 'ijkl' }
  ],
